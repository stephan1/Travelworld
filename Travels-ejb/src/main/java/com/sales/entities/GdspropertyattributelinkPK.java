 ...
 */
@Embeddable
public class GdspropertyattributelinkPK implements Serializable {
    ...
    public GdspropertyattributelinkPK() {
    }

    public GdspropertyattributelinkPK(BigInteger eanhotelid, BigInteger attributeid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GdspropertyattributelinkPK)) {
            return false;
        }
        GdspropertyattributelinkPK other = (GdspropertyattributelinkPK) object;
    ...
    public String toString() {
        return "com.sales.entities.GdspropertyattributelinkPK[ eanhotelid=" + eanhotelid + ", attributeid=" + attributeid + " ]";
    }
